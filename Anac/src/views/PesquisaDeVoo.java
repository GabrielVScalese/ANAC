...
public class PesquisaDeVoo extends JFrame {
	...
	public void initialize(String codigo)
	{
	 ...
	 /**
     * Verifica se existe o código de aeroporto passado por parâmetro.
     * @param codigo String contendo o código do aeroporto desejado.
     * @return Retorna true se o código de aeroporto existe ou false caso o código de aeroporto não exista.
     *  */
	protected boolean existsCode(String codigo) 
	{
	 ...
	 /**
     * Altera o texto dos componentes do formulário e desabilita botões de anterior e próximo caso o objeto dadosAtual seja o primeiro último da lista de aeroportos.
     *  */
